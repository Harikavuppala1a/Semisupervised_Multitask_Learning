...
def get_embeddings_dict(vector_type, emb_dim,data_fold_path):
    if vector_type == 'sswe':
        emb_dim==50
        sep = '\t'
...
with open('saved/raw_data_5.pickle', 'rb') as f_data:
...
print (data_dict['test_en_ind'])
#data_dict = load_data(conf_dict_com['filename'], conf_dict_com['data_folder_name'], conf_dict_com['save_path'], conf_dict_com['TEST_RATIO'], conf_dict_com['VALID_RATIO'], conf_dict_com['RANDOM_STATE'], conf_dict_com['MAX_WORDS_SENT'], conf_dict_com['test_mode'])
