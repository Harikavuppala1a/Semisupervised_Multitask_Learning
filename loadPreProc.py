...
def load_data(filename, data_path, save_path, test_ratio, valid_ratio, rand_state, max_words_sent, test_mode,train_ratio):
  data_dict_filename = ("%sraw_data~%s~%s~%s~%s~%s~%s~%s.pickle" % (save_path, filename[:-4], test_ratio, valid_ratio, rand_state, max_words_sent, train_ratio, test_mode))
...
FOR_LMAP = {
  ...
  3: 'Hyper-sexualization (excluding body shaming)',
  
  4: 'Internalized sexism',

  5: 'Pay gap', 
  
  6: 'Hostile work environment (excluding pay gap)',

  7: 'Denial or trivialization of sexist misconduct', 
  
  8: 'Threats', 
  
  9: 'Rape',

  10: 'Sexual assault (excluding rape)',
  
  11: 'Sexual harassment (excluding assault)',
  
  12: 'Tone policing',

  13: 'Moral policing (excluding tone policing)' ,

  14: 'Victim blaming',
  
  15: 'Slut shaming',
  
  16: 'Motherhood-related discrimination',

  17: 'Menstruation-related discrimination',

  18: 'Religion-based sexism',

  19: 'Physical violence (excluding sexual violence)',
...
LABEL_MAP = {
  ...
  'Hyper-sexualization (excluding body shaming)': 3,
  
  'Internalized sexism': 4, 

  'Pay gap': 5,
  
  'Hostile work environment (excluding pay gap)': 6,
  ...
  'Sexual assault (excluding rape)': 10,
  
  'Sexual harassment (excluding assault)': 11,
  
  'Tone policing': 12,

  'Moral policing (excluding tone policing)': 13,
  ...
  'Menstruation-related discrimination': 17,

  'Religion-based sexism': 18,

  'Physical violence (excluding sexual violence)': 19,
